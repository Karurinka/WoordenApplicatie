...
public class PerformanceTest
{
    ...
    public void splitString() throws Exception
    {
        ...
        String logMessage1mil = String.format("getSplitText - time measured: %d nanoseconds", resultTime1mil);
    ...
    public void getList() throws Exception
    {
        ...
        long resultTime10k = System.nanoTime() - startTime10k;
        String logMessage10k = String.format("getSplitText - time measured: %d nanoseconds", resultTime10k);
        logger.log(Level.INFO, logMessage10k);
